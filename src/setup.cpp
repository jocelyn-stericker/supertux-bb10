  ...
  if (datadir.empty())
    {
      ...
      // Detect datadir
      char exe_file[400];
      if (readlink("/proc/self/exe", exe_file, 400) < 0)
        {
...
void st_general_setup(void)
{
  ...
  black_text  = new Text(datadir + "/images/status/letters-black.png", TEXT_TEXT, 32,36);
  gold_text   = new Text(datadir + "/images/status/letters-gold.png", TEXT_TEXT, 32,36);
  silver_text = new Text(datadir + "/images/status/letters-silver.png", TEXT_TEXT, 32,36);
  blue_text   = new Text(datadir + "/images/status/letters-blue.png", TEXT_TEXT, 32,36);
  red_text    = new Text(datadir + "/images/status/letters-red.png", TEXT_TEXT, 32,36);
  green_text  = new Text(datadir + "/images/status/letters-green.png", TEXT_TEXT, 32,36);
  white_text  = new Text(datadir + "/images/status/letters-white.png", TEXT_TEXT, 32,36);
  //white_small_text = new Text(datadir + "/images/status/letters-white-small.png", TEXT_TEXT, 16,19);
  white_small_text  = new Text(datadir + "/images/status/letters-white-small.png", TEXT_TEXT, 16,18);
  white_big_text   = new Text(datadir + "/images/status/letters-white-big.png", TEXT_TEXT, 40,44);
  yellow_nums = new Text(datadir + "/images/status/numbers.png", TEXT_NUM, 64,64);
